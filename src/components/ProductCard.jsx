    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2 mt-3">
        <motion.button
          ...
          className="px-3 py-2 rounded-lg border border-slate-200 bg-white text-slate-900 font-medium text-sm"
        >
          View
        </motion.button>
        <motion.button
          ...
          className="px-3 py-2 rounded-lg bg-green-600 text-white font-medium text-sm"
        >
          Add
        </motion.button>
      </div>
